...
void xr_object::save_bones(xr_writer& w) const
{
	...
	{
		xr_partition_vec m_parts;
		reset_bones_parts(m_parts);
		w.w_size_u32(m_parts.size());
		w.w_seq(m_parts, xr_writer::f_w_const<xr_partition>(&xr_partition::save));
	}
	w.close_chunk();
}
...
void xr_object::reset_bones_parts(xr_partition_vec& m_parts) const
{
	m_parts.clear();
	if (m_bones.size() == 42) // hands cs\cop
	{
...
#if _MSC_VER && _MSC_VER < 1600
		vector<string> m(_m, _m + 42);
#endif
		for (xr_bone_vec_cit it = m_bones.begin(), end = m_bones.end(); it != end; ++it)
			m.erase(remove(m.begin(), m.end(), (*it)->name()), m.end());

		if (m.empty()){

			xr_partition* part = new xr_partition(0, "default");
			part->add_bone("bip01");
			m_parts.push_back(part);

			part = new xr_partition(1, "left_hand");
			part->add_bone("bip01_l_finger1");
			part->add_bone("bip01_l_finger11");
			part->add_bone("bip01_l_finger12");
			part->add_bone("bip01_l_finger2");
			part->add_bone("bip01_l_finger21");
			part->add_bone("bip01_l_finger22");
			part->add_bone("bip01_l_finger3");
			part->add_bone("bip01_l_finger31");
			part->add_bone("bip01_l_finger32");
			part->add_bone("bip01_l_finger4");
			part->add_bone("bip01_l_finger41");
			part->add_bone("bip01_l_finger42");
			part->add_bone("l_clavicle");
			part->add_bone("l_finger0");
			part->add_bone("l_finger01");
			part->add_bone("l_finger02");
			part->add_bone("l_forearm");
			part->add_bone("l_forearm_twist");
			part->add_bone("l_hand");
			part->add_bone("l_upperarm");
			m_parts.push_back(part);

			part = new xr_partition(2, "right_hand");
			part->add_bone("bip01_r_finger1");
			part->add_bone("bip01_r_finger11");
			part->add_bone("bip01_r_finger12");
			part->add_bone("bip01_r_finger2");
			part->add_bone("bip01_r_finger21");
			part->add_bone("bip01_r_finger22");
			part->add_bone("bip01_r_finger3");
			part->add_bone("bip01_r_finger31");
			part->add_bone("bip01_r_finger32");
			part->add_bone("bip01_r_finger4");
			part->add_bone("bip01_r_finger41");
			part->add_bone("bip01_r_finger42");
			part->add_bone("lead_gun");
			part->add_bone("r_clavicle");
			part->add_bone("r_finger0");
			part->add_bone("r_finger01");
			part->add_bone("r_finger02");
			part->add_bone("r_forearm");
			part->add_bone("r_forearm_twist");
			part->add_bone("r_hand");
			part->add_bone("r_upperarm");
			m_parts.push_back(part);
...
#if _MSC_VER && _MSC_VER < 1600
	vector<string> m(_m, _m + 47);
#endif
	for (xr_bone_vec_cit it = m_bones.begin(), end = m_bones.end(); it != end; ++it)
		m.erase(remove(m.begin(), m.end(), (*it)->name()), m.end());

	if (!m.empty() && !(m.front() == "root_stalker" && m.back() == "bip01"))
	{
		m_parts.push_back(new xr_partition(m_bones)); //reset to default
		return;
	}


	// add_legs
	xr_partition* part = new xr_partition(0, "legs");
	if (m.empty()){
		part->add_bone("bip01");
		part->add_bone("root_stalker");
	}
	part->add_bone("bip01_l_calf");
	part->add_bone("bip01_l_foot");
	part->add_bone("bip01_l_thigh");
	part->add_bone("bip01_l_toe0");
	part->add_bone("bip01_pelvis");
	part->add_bone("bip01_r_calf");
	part->add_bone("bip01_r_foot");
	part->add_bone("bip01_r_thigh");
	part->add_bone("bip01_r_toe0");
	part->add_bone("bip01_spine");
	part->add_bone("bip01_tail");
	m_parts.push_back(part);

	//add torso
	part = new xr_partition(1, "torso");
	part->add_bone("bip01_head");
	part->add_bone("bip01_l_clavicle");
	part->add_bone("bip01_l_finger0");
	part->add_bone("bip01_l_finger01");
	part->add_bone("bip01_l_finger02");
	part->add_bone("bip01_l_finger1");
	part->add_bone("bip01_l_finger11");
	part->add_bone("bip01_l_finger12");
	part->add_bone("bip01_l_finger2");
	part->add_bone("bip01_l_finger21");
	part->add_bone("bip01_l_finger22");
	part->add_bone("bip01_l_forearm");
	part->add_bone("bip01_l_hand");
	part->add_bone("bip01_l_upperarm");
	part->add_bone("bip01_neck");
	part->add_bone("bip01_r_clavicle");
	part->add_bone("bip01_r_finger0");
	part->add_bone("bip01_r_finger01");
	part->add_bone("bip01_r_finger02");
	part->add_bone("bip01_r_finger1");
	part->add_bone("bip01_r_finger11");
	part->add_bone("bip01_r_finger12");
	part->add_bone("bip01_r_finger2");
	part->add_bone("bip01_r_finger21");
	part->add_bone("bip01_r_finger22");
	part->add_bone("bip01_r_forearm");
	part->add_bone("bip01_r_hand");
	part->add_bone("bip01_r_upperarm");
	part->add_bone("bip01_spine1");
	part->add_bone("bip01_spine2");
	m_parts.push_back(part);

	//add head
	part = new xr_partition(2, "head");
	part->add_bone("eye_left");
	part->add_bone("eye_right");
	part->add_bone("eyelid_1");
	part->add_bone("jaw_1");
	m_parts.push_back(part);	
}
