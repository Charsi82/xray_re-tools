...
//! \ingroup OpenMaya
//! \brief \extension Class for working with Maya's profiler. 
/*!
  ...
  To instrument certain code snippet you must create an instance of MProfilerScope. 
...
//! \ingroup OpenMaya
//! \brief \extension MProfilingScope is used to profile code execution time.
/*!
...
public:
    ...
    MProfilingScope(int categoryId, MProfiler::ProfilingColor colorIndex, const char* eventName, const char* description = NULL);
    ~MProfilingScope();
